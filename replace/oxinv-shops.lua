return {
	...
	Ammunation = {
		...
		blip = {
			...
			{ name = 'ammo-9', price = 5, },
			{ name = 'box_ammo_9', price = 500, },
			{ name = 'box_ammo_45', price = 550, },
			{ name = 'box_ammo_50', price = 600, },
			{ name = 'box_ammo_shotgun', price = 100, },
			{ name = 'box_ammo_rifle', price = 500, },
			{ name = 'box_ammo_rifle2', price = 550, },
			{ name = 'box_ammo_sniper', price = 650, },
	...
	HuntingStore = {
		...
		blip = {
			...
			{ name = 'ammo-9', price = 4, },
			{ name = 'box_ammo_9', price = 450, },
			{ name = 'box_ammo_45', price = 500, },
			{ name = 'box_ammo_50', price = 550, },
			{ name = 'box_ammo_shotgun', price = 75, },
			{ name = 'box_ammo_rifle', price = 450, },
			{ name = 'box_ammo_rifle2', price = 500, },
			{ name = 'box_ammo_sniper', price = 600, },
			{ name = 'WEAPON_KNIFE', price = 150 },
			{ name = 'WEAPON_BAT', price = 75 },
	...
	LDOrganics = {
		...
		inventory = {
			...
			{ name = 'joint_ak', price = 50 },
			{ name = 'joint_ogk', price = 55 },
			{ name = 'joint_ph', price = 65 },
			{ name = 'joint_sk', price = 75 },
		}, locations = {
