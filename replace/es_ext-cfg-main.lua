...
Config.DefaultSpawns = { -- If you want to have more spawn positions and select them randomly uncomment commented code or add more locations
      {x = -1087.1283, y = -2823.4453, z = 25.3692, heading = 325.13 },
...
Config.MaxWeight = 26 -- the max inventory weight without a backpack
Config.PaycheckInterval = 8 * 60000 -- how often to receive paychecks in milliseconds
